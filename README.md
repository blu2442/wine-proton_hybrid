...
A hybrid Wine/Proton installer that merges any Wine build directly over a Proton base. Most Wine builds work at the moment, like certain versions of upstream Wine from WineHQ(https://www.winehq.org), certain ones you can grab from Kron4ek's Wine build releases page(https://github.com/Kron4ek/Wine-Builds/releases), and one's you can build yourself from places like WineHQ's source page(https://dl.winehq.org/wine/source/), Wine-TKG's source page/build scripts(https://github.com/Kron4ek/wine-tkg), and Valve Software's source page(https://github.com/ValveSoftware/wine) to name a few good sources.  Any Proton tool works, like the builds you can download from Valve Software off of Steam, Kron4ek's Proton builds(https://github.com/Kron4ek/proton-archive/releases), and GE-Proton builds(https://github.com/GloriousEggroll/proton-ge-custom/releases). Run the installer, use any version of Wine and Proton you'd like, and let it build with whatever combination you choose, producing a single ready-to-use compatibility tool :3
